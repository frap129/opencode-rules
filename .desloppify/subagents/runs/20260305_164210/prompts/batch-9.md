...
Repository root: /var/home/joe/Projects/ai/opencode-rules
Blind packet: /var/home/joe/Projects/ai/opencode-rules/.desloppify/review_packet_blind.json
Batch index: 9
Batch name: Cross-cutting Sweep
Batch dimensions: authorization_consistency
...
- src/debug.test.ts
- src/index.runtime.test.ts
- src/index.integration.test.ts
- src/index.test.ts
- src/runtime.ts
- src/project-fingerprint.test.ts
- src/index.rules.test.ts
- src/rule-filter.ts
